...
public class _09_CombineListsOfLetters {
	...
	private static void printResult(ArrayList<Character> result,
			ArrayList<Character> l1) {
		for (Character character : result) {
			System.out.print(character + " ");
		}
	}

	private static ArrayList<Character> addCharactersFroml2(
			ArrayList<Character> l1, ArrayList<Character> l2,
	...
	private static ArrayList<Character> addCharacters(String[] line,
